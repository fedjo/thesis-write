set title 'Results on Yale A Facedatabase'
set ylabel 'Accuracy (%)'
...
set output 'k10-yaleA-comp.pdf'

set style line 1 lc rgb "#ff0000"
set style line 2 lc rgb "green"
set style line 3 lc rgb "#000080"
...
set key inside left center vertical Right noreverse noenhanced autotitle columnhead box
plot 'facecomp_k10_YaleA.csv' using 1:2  smooth bezier, \
                        '' using 1:3 smooth bezier, \
                        '' using 1:4 smooth bezier, \
                        '' using 1:5 smooth bezier

#plot 'facerec_k10_YaleA.csv' using 1:3, f2(x)
